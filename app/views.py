...
# permission_classes = [DjangoModelPermissionsOrAnonReadOnly]  # Uncomment this line to use Django's built-in model permissions for fine-grained access control, while allowing read-only access for unauthenticated users
    permission_classes = [MyPermission]  # Uncomment this line to use your custom permission class